...
CANDIDATES = [
    ...
    dict(name="Pedro Porro", team="Spain", position="DEF", g90=0.10, start_prob=0.90, pen_taker=False),                  # attacking RB, scored the SF vs France (58'); DEF ×192. ATGS-priced so g90 is a fallback. Added 2026-07-18 (Fable review: had a dead FINAL start-override with no candidate row); expected below the top-4 (DEF halved by lead_shrink)
    dict(name="Rayan Cherki", team="France", position="MID", g90=0.22, start_prob=0.90, pen_taker=False),                # attacking #10, CONFIRMED starter behind Mbappé; Scorito MID (×96) so EV ~15.9. ATGS-priced (implied .253). Added 2026-07-18 lock recheck — slot-4 pivot after Kane benched (Yamal→Cherki, +6.9 EV)
